  ...
  return (
    <Box bgColor='gray.400' h="100%">
      ...
      <Center display="flex" flexDirection="column" mt="30px">
        <Box display="flex" w="100%" justifyContent="center" fontSize="18px" fontWeight="Bold">
        ...
        <Box display="flex">
          <Box display="flex" flexDirection="column" m="5px" justifyContent="space-between">
          ...
          <Box display="flex" flexDirection="column" m="5px" justifyContent="space-around">
